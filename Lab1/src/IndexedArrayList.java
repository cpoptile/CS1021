 ...
 * Course: CS1021-091
 * Winter 2019
 * File header contains class IndexedArrayList
 * Name: poptilec
 * Created 3/11/2020
 */
 ...
 * Words from the selected file are stored in an ArrayList and uses index methods
 * to navigate through that list
 */
public class IndexedArrayList implements AutoCompleter {
