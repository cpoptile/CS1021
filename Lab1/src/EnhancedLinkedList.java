 ...
 * Course: CS1021-091
 * Winter 2019
 * File header contains class EnhancedLinkedList
 * Name: poptilec
 * Created 3/11/2020
 */
 ...
 * Words from the selected file are stored in a LinkedList and uses enhanced for-loops
 * to navigate through that list
 */
public class EnhancedLinkedList implements AutoCompleter {
